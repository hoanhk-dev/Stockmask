...
async def process_company(stt, company_name, page):
    ...
    if not copied_text or len(copied_text.strip()) < 50:
        ...
        row_data = {
            ...
            'Best Title': '',
            'Best URL': '',
            'Result ESG': 'Clipboard empty - search may have failed'
        }
...
async def main():
    ...
    companies = [
        ...
        "ADVANTEST CORPORATION",  # STT 16
        "TOYOTA MOTOR CORPORATION",  # STT 17
